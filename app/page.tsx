...
const features = [
  ...
  },
  {
    ...
    title: 'ConditionScan AI',
    desc: 'Upload images or take photos of visual symptoms, rashes, or conditions for instant AI diagnosis.',
    color: 'text-purple-400',
    bg: 'bg-purple-500/10 border-purple-500/20',
    button: '/condition-scan',
    buttonText: 'Scan Condition →'
  },
  {
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'Medical Chat',
    desc: 'Real-time secure messaging between patients and healthcare professionals.',
    color: 'text-blue-400',
  ...
  },
  {
    ...
    title: 'MedLearn Hub',
    desc: 'Interactive educational resources, symptom checkers, and health condition guides.',
      ...
      <section className="relative overflow-hidden px-6 pt-20 pb-32">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400 leading-relaxed">
            Upload X-rays, MRIs, CT scans, or photos of visible symptoms. Receive AI-assisted findings in seconds.
            Generate clinical-grade reports and get medication suggestions instantly.
          </p>
